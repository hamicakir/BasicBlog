                    ...
                    <div class="entry-media">
                        <div class="post-title">
                            ...
                            <div class="entry-date">
                                <ul>
                                    <li>
                                        <a href='category.php?id=<?php echo $category->id ?>'><?php echo getCategoryTitle($post->category_id); ?></a>
                                    </li>
                        ...
                        <div class="post-content">
                            <?php if($post->post_type == 1){ ?>
                                <img src="panel/uploads/<?php echo $post->img_url; ?>" alt="<?php echo $post->title; ?>">
                            ...
                            <p>
                                <?php echo getShortString($post->description,350); ?>
                            </p>
                        </div>
                        <div class="bubble-line"></div>
